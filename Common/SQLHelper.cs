...
namespace CaterCommon {
    ...
    public static class SQLHelper {
        private static string ConnStr = ConfigurationManager.ConnectionStrings["SQL_server_yqConnectionString"].ConnectionString;//从配置文件中读取连接字符串
        ...
        public static int ExecuteNonQuery(string sql,params SqlParameter[] ps) {
            using(SqlConnection conn = new SqlConnection(ConnStr)) {
                ...
                conn.Open();
                var executeRow =  cmd.ExecuteNonQuery();
